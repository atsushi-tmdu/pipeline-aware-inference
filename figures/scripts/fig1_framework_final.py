...
def main():
    ...
    add_box(ax, 0.62, 0.66, 0.17, 0.14, "Select model with\nmaximum\nperformance", fontsize=17)
    add_box(ax, 0.83, 0.66, 0.14, 0.14, "Selected maximum\nperformance\n$T_{\\mathrm{obs}}$", fontsize=16)

    add_arrow(ax, (0.19, 0.73), (0.25, 0.73))
    add_arrow(ax, (0.57, 0.73), (0.62, 0.73))
    add_arrow(ax, (0.79, 0.73), (0.83, 0.73))
    ...
    add_box(
        ...
        0.15,
        0.14,
        "Generate $B$ null datasets\nunder the declared null\nmechanism",
        fontsize=13,
    )
    add_box(
        ax,
    ...
    add_box(ax, 0.62, 0.25, 0.17, 0.14, "Retain the selected\nnull maximum\n$T_{0b}$", fontsize=16)
    add_box(
        ax,
        0.83,
        0.22,
    ...
    add_arrow(ax, (0.57, 0.32), (0.62, 0.32))
    add_arrow(ax, (0.79, 0.32), (0.83, 0.32))
    """
    ax.text(
        0.5,
        0.08,

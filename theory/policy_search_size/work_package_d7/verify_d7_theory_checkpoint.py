...
def main() -> None:
    ...
    manifest_path = d7 / "D7_THEORY_CHECKPOINT_MANIFEST.json"
    ...
    if failures:
        print("D7 theory checkpoint verification: FAIL")
        for failure in failures:
            print(f"  - {failure}")
        raise SystemExit(1)

    print("D7 theory checkpoint verification: PASS")
    print(f"Checkpoint ID: {payload['checkpoint_id']}")
